...
const Portfolio2 = () => {
  return (
    <>
      ...
      `}</style>
        <div className="flex items-center w-fit justify-center font-sans [background:linear-gradient(45deg,#080b11,theme(colors.slate.800)_50%,#172033)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.slate.600/.48)_80%,theme(colors.teal.500)_86%,theme(colors.cyan.300)_90%,theme(colors.teal.500)_94%,theme(colors.slate.600/.48))_border-box] rounded-2xl border-2 border-transparent animate-border">
        <div className="bg-white dark:bg-black rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-5xl p-4 sm:p-6 md:p-8 lg:p-12 relative overflow-hidden">
            ...
            <div className="text-center md:text-left md:w-1/2 z-10 order-2 md:order-1">
                ...
                Full Stack Developer crafting efficient front-end and back-end solutions.
                </p>
            ...
            <footer className="flex justify-center pt-8 pb-4 md:p-0 md:justify-start md:absolute md:bottom-8 md:left-8 lg:bottom-12 lg:left-12">
                <div className="flex space-x-5 md:space-x-6 text-gray-500 dark:text-gray-400 text-lg md:text-xl">
                    <a href="https://www.linkedin.com/in/bryan-tapel-876271198/" target='_blank' className="hover:text-black dark:hover:text-white transition-colors"><LinkedInIcon /></a>
                    <a href="https://github.com/dayan11776" target='_blank' className="hover:text-black dark:hover:text-white transition-colors"><GithubIcon /></a>
                </div>
            </footer>
